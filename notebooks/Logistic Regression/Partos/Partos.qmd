...
Ver fichero [*Dataset_cleaning*](Dataset_cleaning.html) para ver cómo se han tratado dichos microdatos hasta obtener un conjunto de datos adecuado para la regresión logística, y que tomaremos aquí como punto de partida. El fichero de datos procesado se puede encontrar en [*Partos.xlsx*](../../../files/partos.xlsx)
