...
En este cuaderno vamos a analizar el dataset llamado [*salud.xlsx*](../../../../files/salud.xlsx). Este contiene microdatos relativos a la [Encuesta Nacional de Salud](https://www.ine.es/dyngs/INEbase/es/operacion.htm?c=Estadistica_C&cid=1254736176783&menu=resultados&idp=1254735573175). Concretamente, datos correspondientes al año 2017. Las variables de interés son las siguientes:
