...
En el siguiente dataset disponemos de datos por Comunidades Autónomas de las nueve **dimensiones relativas a la calidad de vida que componen el Índice Multidimensional de Calidad de Vida (IMCV)** \[¡Pincha aquí!\] (https://www.ine.es/experimental/imcv/experimental_ind_multi_calidad_vida.htm), una estadística con carácter experimental. Datos correspondientes al año 2020.
